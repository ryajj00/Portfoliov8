...
import { Image as ImageIcon, Palette, Layers as LayersIcon, Zap as ZapIcon, Code } from "lucide-react";
import { useReducedMotion } from "@/app/hooks/useReducedMotion";
import FooterLegal from "@/app/components/FooterLegal";

gsap.registerPlugin(ScrollTrigger);

// Pixel art gallery images - all files from public/imgs/Pixel Art/
interface PixelArtFile {
  filename: string;
  type: "png" | "gif";
  alt: string;
}

const pixelArtFiles: PixelArtFile[] = [
  { filename: "poging jeep.gif", type: "gif", alt: "Pixel Animation" },
  { filename: "pandesal.png", type: "png", alt: "Derivative Work" },
  { filename: "kurt3.png", type: "png", alt: "Portrait and Avatar Commission" },
  { filename: "animals.png", type: "png", alt: "Content and Stories" },
  { filename: "runnn.gif", type: "gif", alt: "Pixel GIF and Stickers" },
  { filename: "Animation with watermark(500).gif", type: "gif", alt: "Song Cover" },  
...
const features = [
  {
    title: "Sprite Sheets",
    desc: "Optimized sprite sheets for game engines — packed frames, trimmed whitespace, JSON metadata export.",
    icon: LayersIcon,
    highlight: "Engine-ready",
  },
  {
    title: "Animation Loops",
    desc: "Seamless looping animations — idle, walk, attack, death cycles with onion-skinning precision.",
    icon: ZapIcon,
    highlight: "Frame-perfect",
  },
  {
    title: "Color Palettes",
    desc: "Constrained palettes (16/32/64 colors) — cohesive look across characters, environments, UI elements.",
    icon: Palette,
    highlight: "Limited colors",
  },
  {
    title: "Pixel Scaling",
    desc: "Nearest-neighbor upscaling for crisp retro look at any resolution — 1x to 10x without blur.",
    icon: ImageIcon,
    highlight: "Crisp at any size",
  },
  {
    title: "Tileable Assets",
    desc: "Seamless tilesets for platforms, backgrounds, UI panels — edge-matched for infinite tiling.",
    icon: LayersIcon,
    highlight: "Seamless",
  },
  {
    title: "Aseprite Workflow",
    desc: "Native .aseprite source files — layers, tags, frame data preserved for iterative development.",
    icon: Code,
    highlight: "Source included",
  },
];

const highlights = [
  { value: "30", label: "Artworks", suffix: "+" },
  { value: "15", label: "Animations", suffix: "" },
  { value: "8", label: "Static Sprites", suffix: "" },
  { value: "100", label: "Idle Stances", suffix: "%" },
];
...
export default function PixelArtGallery() {
  ...
  // Add body class for page-specific nav styling
  useEffect(() => {
    document.body.classList.add("pixel-art-page");
    return () => document.body.classList.remove("pixel-art-page");
  }, []);
  ...
  const getImageSrc = (filename: string) => `/imgs/Pixel%20Art/${encodeURIComponent(filename)}`;
  ...
  return (
    <>
      <style jsx>{`
        ...
        /* ---- Pixel Art page custom background ---- */
        .project-page {
          padding: 0 0 0;
          background: #21445c;
        }
        .project-page .project-hero-overlay {
          background: linear-gradient(to bottom, transparent 30%, #21445c 100%);
        }
        .project-page footer {
          background: #1a3547;
        }

        /* ---- Boxes / Cards background ---- */
        .project-page .feature-card,
        .project-page .highlight-card,
        .project-page .gallery-item,
        .project-page .tech-card,
        .project-page .tech-card-inline,
        .project-page .process-step,
        .project-page .meta-item,
        .project-page .meta-section,
        .project-page .project-meta-tech,
        .project-page .screenshot-frame {
          background: #1a3547;
          border-color: #2d5a7a;
        }
        .project-page .feature-card:hover,
        .project-page .highlight-card:hover,
        .project-page .gallery-item:hover,
        .project-page .tech-card:hover,
        .project-page .tech-card-inline:hover,
        .project-page .process-step:hover {
          border-color: var(--accent);
        }

        /* ---- Nav bar text color override for this page ---- */
        body.pixel-art-page .nav,
        body.pixel-art-page nav {
          color: #c3d9c5;
        }
        body.pixel-art-page .nav .nav-links a,
        body.pixel-art-page nav .nav-links a {
          color: #c3d9c5;
        }
        body.pixel-art-page .nav .nav-links a:hover,
        body.pixel-art-page nav .nav-links a:hover {
          background-color: #c3d9c5;
          color: #1a3547;
        }
        body.pixel-art-page .nav .logo,
        body.pixel-art-page nav .logo {
          color: #c3d9c5;
        }
        body.pixel-art-page .nav.scrolled,
        body.pixel-art-page nav.scrolled {
          background: rgba(26, 53, 71, 0.92);
          border-bottom-color: #2d5a7a;
        }
        body.pixel-art-page .nav.scrolled .nav-links a:hover,
        body.pixel-art-page nav.scrolled .nav-links a:hover {
          background-color: #c3d9c5;
          color: #1a3547;
        }
        body.pixel-art-page .menu-toggle,
        body.pixel-art-page .menu-toggle.open {
          color: #c3d9c5;
        }
        body.pixel-art-page .menu-overlay {
          background: rgba(26, 53, 71, 0.97);
        }
        body.pixel-art-page .menu-link {
          color: #c3d9c5;
        }
        body.pixel-art-page .menu-footer {
          color: #c3d9c5;
        }
      ...
      <div className={`intro-loader${loaded ? " done" : ""}`}>
        <h1 className="intro-title">Pixel Art Gallery</h1>
        <span className="intro-sub">Sprite Artist</span>
      ...
      <article className="project-page" ref={scope}>
        ...
        <div className="project-hero">
          <div
            ...
            style={{ backgroundImage: "url('/imgs/Pixel Art/pandesal.png')" }}
          />
          <div className="project-hero-overlay" />
          <div className="project-hero-content">
            <span className="project-eyebrow">Project 04</span>
            <h1 className="project-title">Pixel Art Gallery</h1>
            <p className="project-tagline">
              Hand-crafted pixel-art sprites and animation — character work built frame by frame
              as a pixel and sprite artist using Aseprite.
            </p>
          </div>
        </div>
        ...
        <div className="project-meta-tech">
          <div className="meta-section">
            <div className="meta-item">
              ...
              <span className="meta-value">Pixel & Sprite Artist</span>
            </div>
            <div className="meta-item">
              <span className="meta-label">Type</span>
              <span className="meta-value">Gallery</span>
            </div>
            <div className="meta-item">
        ...
        {/* Featured screenshot - using first gallery image as featured */}
        <div className="project-screenshot">
          <div className="screenshot-frame">
            <Image
              className="featured-image"
              src="/imgs/Pixel Art/pandesal.png"
              alt="Featured: Pandesal"
              fill
        ...
        <div className="project-gallery">
          ...
          <div className="gallery-grid">
            {pixelArtFiles.map((item): React.ReactElement => {
        ...
        <div className="project-back">
          <a className="back-link" onClick={handleBackToWork}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
